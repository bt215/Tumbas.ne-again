	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="{{ url('check_login_pembeli') }}" method="post">
					{{ csrf_field() }}
					...
					<div class="text-center p-t-136">
						<p class="txt2">Dont Have Account?</p>
						<a class="txt2" href="{{ url('/register_pembeli') }}">
